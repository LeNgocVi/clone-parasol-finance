    ...
    <div className="App">
        ...
        <div className="max-w-7xl mx-auto flex whitespace-nowrap justify-between justify-center gap-x-4 py-3 sm:px-6 lg:px-5">
          ...
          >
            ...
            <span className="flex gap-2 ml-2 items-center px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-white bg-opacity-50 rounded-l-full">
              <img style={{ height: "16px", width: "16px" }} src={window}></img>
              Ctrl+D
            </span>
            <span className="flex gap-2 items-center px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-white bg-opacity-50 rounded-r-full">
              <img style={{ height: "16px", width: "16px" }} src={mac}></img>
              Cmd+D
            </span>
          </a>
          <a
      ...
      <body>
        <div className="relative">
          <div
            style={{ minHeight: "94.600px" }}
            className="max-w-7xl md:mt-6 text-gray-200 mx-auto px-5"
          >
            <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
              <div
                style={{ minHeight: "46.600px" }}
                className="flex min-w-[249px] mg-r justify-start lg:w-0 lg:flex-1"
              >
                <a href="/">
                  <img
                    style={{ maxHeight: "41px", minWidth: "250px" }}
                    alt=""
                    aria-hidden="true"
              ...
              <nav
                class="hidden md:flex items-baseline space-x-10"
          ...
          <div className="flex flex-col gap-y-6 lg:gap-y-24">
            <section className="mt-6">
              <div className="mx-auto grid max-w-7xl grid-cols-12 gap-0 px-5 py-6">
                  ...
                  <div className="pb-3">
                    ...
                    <h1 className=" text-4xl font-extrabold tracking-tight text-white  sm:leading-none lgmt-7 lg:text-4xl xl:text-6xl">
                      ...
                      <span className="text-transparent bg-clip-text bg-purple-2 leading-normal whitespace-nowrap  sm:block">
                        <span className="text-white">Governed</span> IDO
                        Platform
                      </span>
                    </h1>
                ...
                <div className="relative- mt-20  justify-end sm:mt-24 lg:col-span-6 lg:mt-0 lg:flex">
                  <div className="w-full absolute-aspect-square relative -mt-12 -mr-3 ">
                    <div className="main_logo__jLWc5">
                      <img
                        ...
                        src="https://parasol.finance/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-min.3409a0b0.png&w=3840&q=75 "
                      ></img>
                    </div>
                    <div className="main_token__BGF5P">
                      <img
                        ...
                        src="https://parasol.finance/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo_q-min.b35f50c9.png&w=3840&q=75 "
                      ></img>
                    </div>
                    <div className="main_parasol__hoDLe">
                      <img
                        ...
                        src="https://parasol.finance/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo_p-min.9a3293f1.png&w=3840&q=75 "
                      ></img>
                    </div>
                  </div>
                </div>
            ...
            <section>
              <div
                style={{ marginTop: "-6px" }}
                className="mx-auto px-5 max-w-7xl"
              >
                <div className="upcoming ">
                  ...
                  <div style={{ paddingTop: "8px" }}>
                    <button
                      style={{ maxWidth: "191.663px", maxHeight: "48px" }}
                      className="filter hover-fillter"
                    >
                ...
                <div className="card1 hover-card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="token">
                      ...
                      <button className="text-base bg2 more-hover">
                        More Info
                      </button>
                    </div>
                  </div>
              ...
              <div className="viewall">
                <a className="buttonviewall waller-hover" href="#">
                  View All Projects
                  <i class="fas fa-angle-double-right right-more"></i>
                </a>
              </div>
            </section>
          </div>
        ...
        <footer className="bg-[#231f38]-bg-opacity-40-pt-10 mt-12">
          <div className="mx-auto grid max-w-7xl grid-cols-3 px-5  lg:py-10">
            <div className="col-span-12 flex flex-col  justify-center space-y-8 lg:col-span-1 lg:items-start">
              ...
              <div className="flex space-x-6 icon-footer">
            ...
            <div className="mt-12 hidden grid-cols-2 gap-8 text-right lg:col-span-2 lg:grid xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-4 space-y-4">
                    <li className="text-base">About Parasol</li>
                    <li className="text-base">Documentation</li>
                    <li className="text-base">Github Organization</li>
                    <li className="text-base">Token Address</li>
                  </ul>
                </div>
                <div className=" md:mt-0">
                  <h3 className="text-sm font-bold uppercase tracking-wider">Useful Links</h3>
                  <ul className="mt-4 space-y-4">
                    <li className="text-base">Apply for IDO</li>
                    <li className="text-base">WhitePaper</li>
                    <li className="text-base">Press Kit</li>
                    <li className="text-base">Tiers System</li>
                  </ul>
                </div>
              </div>
              <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                  ...
                  <ul className="mt-4 space-y-4">
                    ...
                    <li className="text-base">Telegram</li>
                    <li className="text-base">Discord</li>
                    <li className="text-base">Medium</li>
                  </ul>
                </div>
                <div className=" md:mt-0">
          ...
          <div className="py-10">
            <div style={{minHeight:"26.4px"}} className="mx-auto grid max-w-7xl  gap-5 px-5 text-sm lg:grid-cols-2 lg:gap-0 lg:text-base">
              <p style={{fontSize:"16px"}} className=" lg:text-left">Copyright © 2022 Parasol Finance. All rights reserved.</p>
              <p style={{fontSize:"16px"}} className="flex flex-1 items-center justify-end gap-x-3 text-center lg:text-right">
                <div>
                Build with
                <i style={{color:"violet", marginLeft:"0.5rem", marginRight:"0.5rem"}} class="fas fa-heart "></i>
                in Europe
                </div>
                <span>|</span>
                <a className="inline-flex items-center justify-center gap-x-1">
                <i  class="fab fa-github "></i>
                Official GitHub
                </a>
                <span>|</span>
                <div>
                Crafted by
                <a style={{marginLeft:"5px"}} className="font-medium">Clint ⚡️</a>
                </div>
              </p>
            </div>
          </div>
          ...
          <div className="py-11">
            <div className="mx-auto max-w-7xl px-5 footer-right1">
              ...
              <div className="footer-right2">
                ...
                <p style={{ paddingRight: "0px", paddingLeft:"1px" }} className="pad1">
                  Official GitHub
                  <span style={{ paddingLeft: "12px", paddingRight: "10px" }}>
                    |
                  </span>
                  Crafted by <span style={{fontWeight:"500"}}>Clint ⚡️</span>
                </p>
              </div>
            </div>
          </div>
